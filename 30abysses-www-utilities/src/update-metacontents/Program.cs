...
namespace _30abysses.WWW.Utilities.UpdateMetaContents
{
    public static class Program
    {
        public static int Main(string[] commandLineArguments)
        {
            ...
            var updateMetaContentsVisitor = new UpdateMetaContentsVisitor(contentsRoot.Path, outputDirectoryPath);
            ((IVisitable) contentsRoot).Accept(updateMetaContentsVisitor);
            return 0;
        }
    }
}
